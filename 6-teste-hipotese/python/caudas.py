...
t_stat2, p_value2 = stats.ttest_1samp(dados, n, alternative='greater') # Teste t Unicaudal à Direita (alternative='greater')
...
t_stat2, p_value2 = stats.ttest_1samp(dados, n, alternative='less') # Teste t Unicaudal à Direita (alternative='less')
print("Atraves do pacote: t=", round(t_stat2, 3), " p-value=", round(p_value2, 4) )
...
t_stat2, p_value2 = stats.ttest_1samp(dados, n, alternative='two-sided') # Teste t Unicaudal à Direita (alternative='two-sided')
print("Atraves do pacote: t=", round(t_stat2, 3), " p-value=", round(p_value2, 4) )
